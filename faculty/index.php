      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
			...
			<li><a href="index.php?page=update_task"><span class="glyphicon glyphicon-asterisk"></span> Update Task</a></li>
			<li><a href="index.php?page=message"><span class="glyphicon glyphicon-asterisk"></span> Interactions</a></li>
